...
/*   Updated: 2022/09/29 05:24:33 by leonardkrie      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_printf_s_minus(const char *str, int i, va_list *argptr);
int		ft_printf_s_nominus(const char *str, int i, va_list *argptr);
...
//ft_printf.c
char	ft_argtype(const char *str, int i, va_list *argptr);
